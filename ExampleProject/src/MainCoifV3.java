...
public class MainCoifV3 {
	...
	public static List<HistResult> performCircles2(int[][] image, int radius, List<MoravecResult> results,
		...
		for (MoravecResult mr : results) {
			...
			HistResult hr = new HistResult(hist, hist2, mr.getX(), mr.getY());
	...
	public static CircleResult circles3(int[][] image, final int circleX, final int circleY, final int radius) {
		...
		CircleResult circleResult = new CircleResult(hist, hist2);
	...
	public static void process(final String file1, final String file2, final int fileIndex) {
		...
		do {
			...
			List<HistResult> hrlist = performCircles2(image, 24, morResults, binMergeCount);
			List<HistResult> hrlist2 = performCircles2(image2, 24, morResults2, binMergeCount);

			System.out.println("Circles step done.");
			System.out.println("Feature matching step...");

			final int binThreshold = 3;
			...
			System.out.println("Can complete feature matching: " + (featureMatches.size() < 5) + ", " + (evaluateFeatureMatchCloseness(featureMatches) >= (featureMatches.size() * 0.8)));
		} while (featureMatches.size() < 5 || evaluateFeatureMatchCloseness(featureMatches) >= (featureMatches.size() * 0.8));
	...
	public static void main(String[] args) throws IOException {
		final String[] files1 = { "Test48.png", "Test37.jpg", "Test7.jpg", "Test4.jpg", "Test99.jpg", "Test71.jpg",
				"Test81.jpg" };
		final String[] files2 = { "Test49.png", "Test38.jpg", "Test6.jpg", "Test5.jpg", "Test100.jpg", "Test70.jpg",
				"Test82.jpg" };

		for (int i = 0; i < files1.length; ++i) {
			System.out.println(files1[i] + " and " + files2[i]);
