...
public class HistResultListMatcherUpright implements Callable {
	...
	public HistResultListMatcherUpright(List<HistResultList> hrlist, List<HistResultList> hrlist2, Graphics2D g2d, int binThreshold2, int binThreshold) {
		this.hrlist = hrlist;
